...
### ৭.১ ডিসকাউন্ট কুপন কোড সিস্টেম

কেনার ফর্মে এখন একটা "Discount Coupon" বক্স আছে — ইউজার কোড বসিয়ে Apply করলে পাঠাতে হবে এমন টাকার পরিমাণ কমে যায়, আর সেটাই ক্রয় অনুরোধে সেভ হয়।

**অ্যাডমিন প্যানেল → Coupons** থেকে ম্যানেজ করবেন:
- **+ New Coupon** — কোড দিন (বা Generate বাটনে র‍্যান্ডম কোড বানান), Percentage (%) না Fixed Amount (৳) বেছে নিন এবং মান দিন
- **কোন কোর্সে প্রযোজ্য** — সব কোর্সে, বা নির্দিষ্ট কয়েকটা কোর্স বেছে দিন
- **Max Total Uses** — কতবার সর্বমোট ব্যবহার করা যাবে (০ = আনলিমিটেড)
- **Expiry Date** — মেয়াদ (না দিলে মেয়াদহীন)
- **Active টগল** — যেকোনো সময় কুপন বন্ধ/চালু করতে পারবেন, বা টেবিলের toggle আইকনে ক্লিক করে দ্রুত অন/অফ করতে পারবেন

**পাইরেসি ঠেকানোর ব্যবস্থা:** কুপনের ডকুমেন্ট আইডি নিজেই কোড, আর `firestore.rules.txt`-এ যোগ করা নতুন `coupons` রুল অনুযায়ী কোনো সাধারণ ইউজার active/expiry/maxUses/মূল্য — এসবের একটাও বদলাতে পারবে না, শুধু একটামাত্র শর্তসাপেক্ষ "রিডিম" করতে পারবে যা প্রতি অ্যাকাউন্টে সর্বোচ্চ একবারই কাজ করে (একই কুপন দুইবার ব্যবহার করা যাবে না)। কেনার ফর্ম সাবমিট করার মুহূর্তেও কুপনটা আবার একটা Firestore transaction-এর ভেতর ফ্রেশ করে যাচাই হয়, যাতে একসাথে অনেকে শেষ স্লট নেওয়ার চেষ্টা করলেও কোটা কখনো ছাড়িয়ে না যায়। **এই আপডেটের পর অবশ্যই ধাপ ২-এ দেখানো Firestore Rules আবার Firebase Console-এ বসিয়ে দিন — নাহলে কুপন ফিচার কাজ করবে না।**

Purchase Requests তালিকা/ডিটেইল/PDF রসিদ — সবখানে কোন রিকোয়েস্টে কোন কুপন কত ছাড় দিয়েছে তা দেখা যাবে।
